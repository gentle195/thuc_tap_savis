...
public class Config {
    ...
    public static String vnp_TmnCode = "26OJ85OB";
    public static String vnp_HashSecret = "ZSZRBZEIBESPSNUWCYHSSYFPFVTACZYT";
    ...
    public static String getUrlMuaNgay(
            String emailNguoiNhann,
            BigDecimal tienGiamGia,
            String nameGiamGia,
            String sdtNguoiNhan,
        ...
        vnp_ReturnurlMuaNgay = vnp_ReturnurlMuaNgay
                + "emailNguoiNhann=" + emailNguoiNhann + "&tienGiamGia=" + tienGiamGia + "&nameGiamGia="
                + nameGiamGia + "&sdtNguoiNhan=" + sdtNguoiNhan + "&tienShipHD="
                + tienShipHD + "&hoaDonId=" + hoaDonId;
